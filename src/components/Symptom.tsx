import { IonButton, IonCardHeader, IonCheckbox, IonCol, IonContent, IonGrid, IonHeader, IonInput, IonItem, IonLabel, IonList, IonListHeader, IonRadio, IonRadioGroup, IonRow, IonText } from "@ionic/react";
import './Symptom.css'
function Symptom() {
    return (
        <IonContent>
            ...
            <IonGrid>
                <form className="container">
                    ...
                    <IonRow>
                        <IonCol size="8">
                            <IonLabel className="text">My Temperature (°C) </IonLabel></IonCol>
                        <IonCol size="4">
                            <IonInput className="col-75" type="number"></IonInput></IonCol>
            ...
            <IonGrid>
                <form className="container">
                    ...
                    <IonRow>
                        ...
                        <IonCol size="1">
                            <IonCheckbox></IonCheckbox> </IonCol>
                        <IonCol size="7">
